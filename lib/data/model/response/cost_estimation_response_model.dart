...
class CostEstimationResponseModel {
  final Rajaongkir? rajaongkir;

  CostEstimationResponseModel({
    this.rajaongkir,
  });

  factory CostEstimationResponseModel.fromJson(String str) =>
      CostEstimationResponseModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory CostEstimationResponseModel.fromMap(Map<String, dynamic> json) =>
      CostEstimationResponseModel(
